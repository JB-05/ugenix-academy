    ...
    <div className="dark-page">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        <div className="dark-card p-8 md:p-10 lg:p-12">
          ...
          <h1 className="mb-8 text-text-primary font-medium">Privacy Policy</h1>
          
          <div className="dark-prose">
            <section>
              <h2 className="text-xl font-medium text-text-primary mb-4">1.1 Introduction</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-xl font-medium text-text-primary mb-4">1.2 Information We Collect</h2>
              <p className="mb-4">
              ...
              <div className="space-y-4 ml-4">
                <div>
                  <h3 className="text-lg font-medium text-text-primary mb-2">a. Personal and Academic Information</h3>
                  <p>
                ...
                <div>
                  <h3 className="text-lg font-medium text-text-primary mb-2">b. Payment Verification Information</h3>
                  <p>
                ...
                <div>
                  <h3 className="text-lg font-medium text-text-primary mb-2">c. Usage and Communication Information</h3>
                  <p>
            ...
            <section>
              <h2 className="text-xl font-medium text-text-primary mb-4">1.3 Purpose of Information Collection</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-xl font-medium text-text-primary mb-4">1.4 Disclosure and Sharing of Information</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-xl font-medium text-text-primary mb-4">1.5 Data Storage and Security Measures</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-xl font-medium text-text-primary mb-4">1.6 Data Retention</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-medium text-text-primary mb-4">1.7 Children and Minor Learners</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-medium text-text-primary mb-4">1.8 User Choices and Communication Preferences</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-medium text-text-primary mb-4">1.9 Updates to This Privacy Policy</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-medium text-text-primary mb-4">1.10 Contact Information</h2>
              <p className="mb-2">
              ...
              <div className="ml-4 space-y-1">
                <p>
                  <strong className="text-text-primary">Ugenix Academy</strong>
                </p>
                <p>Kerala, India</p>
                <p>
                  Email:{' '}
