    ...
    <div className="min-h-screen pt-32 md:pt-36 pb-16 md:pb-24">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        <div className="rounded-3xl bg-white/70 backdrop-blur-xl border border-white/70 shadow-lg shadow-black/10 p-8 md:p-10 lg:p-12">
          ...
          <h1 className="mb-8 text-slate-deep font-medium">Terms & Conditions</h1>
          
          <div className="space-y-8 text-neutral-muted leading-relaxed">
            <section>
              <h2 className="text-xl font-medium text-slate-deep mb-4">2.1 Acceptance of Terms</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-xl font-medium text-slate-deep mb-4">2.2 Nature of Services</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-medium text-slate-deep mb-4">2.3 Eligibility and Enrollment</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-medium text-slate-deep mb-4">2.4 User Responsibilities</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-medium text-slate-deep mb-4">2.5 Intellectual Property Rights</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-xl font-medium text-slate-deep mb-4">2.6 Class Recordings</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-medium text-slate-deep mb-4">2.7 Fees and Payments</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-medium text-slate-deep mb-4">2.8 Suspension and Termination</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-medium text-slate-deep mb-4">2.9 Disclaimer of Guarantees</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-medium text-slate-deep mb-4">2.10 Limitation of Liability</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-medium text-slate-deep mb-4">2.11 Governing Law and Jurisdiction</h2>
              <p>
