  ...
  return (
    <section className="relative overflow-hidden bg-[#050505]">
      ...
      <div className="relative mx-auto max-w-[1400px] px-6 lg:px-10">
        <div className="grid min-h-0 items-start gap-8 py-8 sm:gap-10 sm:py-10 lg:min-h-[900px] lg:grid-cols-[1fr_1.1fr] lg:gap-0 lg:py-0">
          {/* LEFT CONTENT */}
          <motion.div
            initial={{ opacity: 0, x: -30 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.8 }}
            className="relative z-30 flex flex-col items-center justify-center pt-20 text-center sm:pt-22 lg:min-h-[900px] lg:justify-center lg:pt-0 lg:pb-0"
          >
            ...
            <p className="mx-auto mt-6 max-w-[520px] text-base leading-relaxed text-zinc-400 sm:mt-8 sm:text-lg lg:text-[22px]">
              We train students through real-world project simulation
              so they become job-ready before they graduate.
            </p>

            <div className="mt-8 flex w-full max-w-md flex-col items-center justify-center gap-4 sm:mt-10 sm:max-w-none sm:flex-row sm:gap-5">
          ...
          <motion.div
            ...
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.8 }}
            className="relative w-full lg:min-h-[900px]"
          >
            <div className="relative mx-auto h-[380px] w-full max-w-[420px] sm:h-[440px] sm:max-w-[500px] md:h-[520px] md:max-w-[580px] lg:absolute lg:inset-0 lg:mx-0 lg:h-full lg:max-w-none">
              ...
              {/* Character — fills visual frame on all breakpoints */}
              <div className="absolute inset-x-0 bottom-0 top-[2%] z-20 flex items-end justify-center lg:top-0 lg:justify-end lg:pr-[110px] xl:pr-[120px]">
                <Image
                  ...
                  height={1024}
                  priority
                  className="relative z-20 h-full w-auto max-w-[118%] origin-bottom scale-[1.18] object-contain object-bottom drop-shadow-[0_0_30px_rgba(255,98,0,0.18)] sm:max-w-[122%] sm:scale-[1.22] md:max-w-[125%] md:scale-[1.28] lg:h-[500px] lg:max-w-none lg:scale-[1.35] lg:translate-x-[85px] lg:-translate-y-[95px] [mask-image:linear-gradient(to_bottom,black_0%,black_84%,transparent_100%)] [-webkit-mask-image:linear-gradient(to_bottom,black_0%,black_84%,transparent_100%)]"
                />
              </div>
            </div>

            {/* Glass stat cards — below character on mobile, right on desktop */}
            <div className="relative z-20 mx-auto mt-5 w-full max-w-[420px] sm:mt-6 sm:max-w-[500px] md:max-w-[580px] lg:absolute lg:right-0 lg:top-1/2 lg:mt-0 lg:w-[210px] lg:max-w-[210px] lg:-translate-y-1/2 xl:w-[230px] xl:max-w-[230px]">
              <HeroStatCards />
            </div>
          </motion.div>
        </div>
